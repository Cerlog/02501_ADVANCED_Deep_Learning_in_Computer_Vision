...
def image_to_patches(image, patch_size, image_grid=True):
    ...
    if image_grid:
        ...
        """
        patches = rearrange(image, 'b c (h1 h2) (w1 w2) -> b c h1 w1 h2 w2', h1=patch_h, w1=patch_w)
        """
        ...
        """
        patches = rearrange(patches, 'b c h1 w1 h2 w2 -> b (h1 w1) c h2 w2')
    else:
        """
        ...
        """
        patches = rearrange(image, 'b c (h1 h2) (w1 w2) -> b (h1 w1) (c h2 w2)', h1=patch_h, w1=patch_w) 
